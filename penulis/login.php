...
<?php include '../includes/header_penulis_login.php'; ?>
    ...
    <main>
      <div class="container-fluid">
        ...
        <div class="container-fluid mt-4 text-mattBlackDark" style="max-width: 400px;">
          <div class="card">
            <div class="card-header text-center bg-primary" style="font-weight: bold; font-size: 20px; padding: 15px 0; color: white;">Login Penulis</div>
            <div class="card-body">
              <form method="POST" autocomplete="on" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                ...
                <br>
                <button type="submit" class="btn btn-warning btn-block" name="submit" value="submit" style="border-radius: 50px; margin-bottom: 10px;">Login</button>
                <a href="../pengunjung/register.php">Create New Account</a>
