  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-mattBlackLight fixed-top">
    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
      <form class="form-inline my-2 my-lg-0" method="POST" action="search.php">
        ...
        <button class="btn btn-primary my-2 my-sm-0" type="submit" name="search_post" onClick="getPostsBySearch()">Search</button>
      </form>
    </div>
  </nav>
    ...
    <div class="sideMenu bg-mattBlackLight">
      <div class="sidebar">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a href="./admin/login.php" class="nav-link px-2">
